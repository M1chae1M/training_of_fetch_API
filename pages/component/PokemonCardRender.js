...
export default class PokemonCardRender extends React.Component{
    ...
    render(){
        ...
        const {cardWidth,cardHeight,fullScreen,ID,pokemon_data}=this.props
        const {height,base_experience,abilities,stats,name,type,weight}=pokemon_data??{}
        const styles={
            PokemonCardRender:{
        ...
        return(
            <div className="PokemonCard" style={styles.PokemonCardRender}>
                {
                    loadingState?
                        <PokemonCardRenderLOADING fullScreen={fullScreen} cardHeight={cardHeight} pokemon_data={pokemon_data}>
